        ...
        {!showProducts ? (
          <>
            ...
            <div className="space-y-3 mb-6">
              <button className="w-full flex items-center justify-center gap-3 rounded-full border border-gray-700 bg-transparent px-6 py-3.5 text-base font-medium text-white hover:bg-gray-900 transition-colors">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <input
                ...
                required
                className="w-full rounded-full border border-gray-700 bg-gray-900 px-6 py-3.5 text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[var(--brand)] focus:border-transparent transition-all"
              />
              <button
                type="submit"
                className="w-full rounded-full bg-white text-gray-900 px-6 py-3.5 text-base font-semibold hover:bg-gray-100 transition-colors"
              >
                Continue
              </button>
            </form>
